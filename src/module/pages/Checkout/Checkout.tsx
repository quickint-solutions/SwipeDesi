                                ...
                                <div className="section-title">
                                    <div className="sub-title">
                                        ...
                                        <ol className="breadcrumb">
                                            <li className="breadcrumb-item"><a className="text-white text-uppercase" href="index.html">Home</a></li>
                                            <li className="breadcrumb-item active">Shop Checkout</li>
                                        </ol>
                                    </div>
                                    <h2 className="title text-white"><strong>Shop Checkout</strong></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="checkout-info bg-light mb-4 mb-md-5">
                                    ...
                                    <p className="mb-0"><span>Returning customer?</span> <a className="text-secondary" href="sign-in.html">Click here to login</a></p>
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="checkout-info-coupon mb-4 mb-md-5">
                                    <p className="checkout-info bg-light mb-4">
                                        ...
                                        <a className="text-secondary" data-bs-toggle="collapse" href="#collapsecoupon" role="button" aria-expanded="false" aria-controls="collapsecoupon">
                                    ...
                                    <div className="collapse" id="collapsecoupon">
                                        <div className="checkout-coupon">
                                            ...
                                            <a href="#" className="btn btn-secondary"> <span> Apply coupon</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="checkout checkout-form">
                                    <form className="row">
                                        <div className="mb-3 col-sm-12">
                                            ...
                                            <input type="text" className="form-control" placeholder="First Name" value={billingDetail.fname} onChange={(e) => handleChangeBillingDetail("fname", e.target.value)} />
                                        </div>
                                        <div className="mb-3 col-sm-12">
                                            <label className="form-label">Last name</label>
                                            <input type="text" className="form-control" placeholder="Last Name" value={billingDetail.lname} onChange={(e) => handleChangeBillingDetail("lname", e.target.value)} />
                                        </div>
                                        <div className="mb-3 col-sm-12">
                                            <label className="form-label">Company name</label>
                                            <input type="text" className="form-control" placeholder="Company Name" value={billingDetail.companyName} onChange={(e) => handleChangeBillingDetail("companyName", e.target.value)} />
                                        </div>
                                        <div className="mb-3 select-border col-sm-12">
                                            ...
                                            <select className="form-control basic-select" onChange={(e) => handleChangeBillingDetail("country", e.target.value)}>
                                                <option value="Armenia" selected={true}>Armenia</option>
                                        ...
                                        <div className="mb-3 col-sm-12">
                                            ...
                                            <input type="text" className="form-control" placeholder="Address Line 1" value={billingDetail.addressLine1} onChange={(e) => handleChangeBillingDetail("addressLine1", e.target.value)} />
                                        </div>
                                        <div className="mb-3 col-sm-12">
                                            <input type="text" className="form-control" placeholder="House number and street name" value={billingDetail.addressLine2} onChange={(e) => handleChangeBillingDetail("addressLine2", e.target.value)} />
                                        </div>
                                        ...
                                        <div className="mb-3 col-sm-12">
                                            ...
                                            <input type="text" className="form-control" placeholder="Postal Code" value={billingDetail.zip} onChange={(e) => handleChangeBillingDetail("zip", e.target.value)} />
                                        </div>
                                        <div className="mb-3 col-sm-12">
                                            <label className="form-label">Phone</label>
                                            <input type="text" className="form-control" placeholder="Phone Number" value={billingDetail.phone} onChange={(e) => handleChangeBillingDetail("phone", e.target.value)} />
                                        </div>
                                        <div className="col-sm-12 mb-0">
                                            <label className="form-label">Email Address:</label>
                                            <input type="email" className="form-control" placeholder="Email Address" value={billingDetail.email} onChange={(e) => handleChangeBillingDetail("email", e.target.value)} />
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <div className="col-md-6 mt-5 mt-md-0">
                                ...
                                <div className="checkout-review ">
                                        ...
                                        <table className="table cart">
                                            <tbody>
                                                ...
                                                {cartData.length > 0 ?
                                                    cartData.map((value: any, key: number) => (
                                                        <tr>
                                                            <td> {value.ProductName} × {value.Quantity} </td>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="product-total amount"><strong> ${productDetail?.SubTotal?.toFixed(2)}</strong></td>
                                                </tr>
                                                <tr>
                                                    <th className="product-name" scope="row">Tax</th>
                                                    <td className="product-total amount"><strong> ${productDetail?.TaxRateAmount ? productDetail?.TaxRateAmount?.toFixed(2) : "0.00"}  {productDetail?.TaxRate ? '(' + productDetail?.TaxRate + '%)' : ""}</strong></td>
                                                </tr>
                                                <tr>
                                                    <th className="product-name" scope="row">Provincial Sales Tax</th>
                                                    <td className="product-total amount"><strong> ${productDetail?.ProvincialSalesTax ? productDetail?.ProvincialSalesTax?.toFixed(2) : "0.00"}  {productDetail?.ProvincialSalesTax ? '(' + productDetail?.ProvincialSalesTax + '%)' : ""}</strong></td>
                                                </tr>
                                                <tr>
                                                    <th className="product-name" scope="row">Federal GST Amount</th>
                                                    <td className="product-total amount"><strong> ${productDetail?.FederalGSTAmount ? productDetail?.FederalGSTAmount?.toFixed(2) : "0.00"}  {productDetail?.FederalGST ? '(' + productDetail?.FederalGST + '%)' : ""}</strong></td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                    ...
                                    <div className="accordion" id="accordionExample">
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="cardPayment">
                                                <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCardPayment" aria-expanded="false" aria-controls="collapseOne">
                                                    Card Payment <i className="fas fa-chevron-down fa-xs"></i>
                                                </button>
                                            </h2>
                                            <div id="collapseCardPayment" className="accordion-collapse collapse show" aria-labelledby="cardPayment" data-bs-parent="#accordionExample">
                                                <div className="accordion-body">
                                                    <div>
                                                        <div style={{ position: "relative" }}>
                                                            <svg className="cardAll" {...getCardImageProps({ images })} style={{ display: "flex", height: "100%", position: "absolute", zIndex: "1", alignItems: "center", bottom: "0", left: "160px", top: "0", width: "35px" }} />
                                                            <input value={paymentCardDetail.cardNumber} {...getCardNumberProps({ onChange: (e: any) => handlechangePaymentCardDetail("cardNumber", e.target.value) })} placeholder="Card Number" className="input" />
                                                    ...
                                                    <div>
                                                        <input value={paymentCardDetail.expiryDate} {...getExpiryDateProps({ onChange: (e: any) => handlechangePaymentCardDetail("expiryDate", e.target.value) })} placeholder="Expiry Date" className="label" />
                                                    ...
                                                    <div>
                                                        <input value={paymentCardDetail.cvv} {...getCVCProps({ onChange: (e: any) => handlechangePaymentCardDetail("cvv", e.target.value) })} placeholder="CVV" className="input" />
                                    ...
                                    <div className="col-12  mt-4">
                                        <a href="javascript:void(0)" className="btn btn-secondary checkout-button d-grid" onClick={() => saveBillingAddress()}>Place Order</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <a href="javascript:void(0)" className="btn btn-secondary checkout-button d-grid" onClick={() => navigate("/")}>Go To Home</a>
                            </div>
                        </div>
                    </div>
                </section>
