                        ...
                        <div className="col-md-12 position-relative">
                            <div className="header-inner-title">
                                <div className="section-title">
                                    ...
                                    <h2 className="title text-white"><strong>Mandir</strong></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                {/* <div className="header-inner-shape" style="background-image: url('images/bg/02.png');"></div> */}
            </section>

            <section className="space-ptb">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 mt-4 mt-md-5 mt-lg-0">
                                    ...
                                    <div className="widget-content">
                                        <div className="widget-categories">
                                            <ul className="list-unstyled list-style list-style-underline mb-0">
                                                <li><a className="d-flex" href="javascript:void(0)">Armchairs <span className="ms-auto"><div className="count">8</div></span></a></li>
                                                <li><a className="d-flex" href="javascript:void(0)">Dining Chair <span className="ms-auto"><div className="count">5</div></span></a></li>
                                                <li><a className="d-flex" href="javascript:void(0)">Dining Table <span className="ms-auto"><div className="count">14</div></span></a></li>
                                                <li><a className="d-flex" href="javascript:void(0)">Lighting <span className="ms-auto"><div className="count">13</div></span></a></li>
                                                <li><a className="d-flex" href="javascript:void(0)">Living Room<span className="ms-auto"><div className="count">10</div></span></a></li>
                                                <li><a className="d-flex" href="javascript:void(0)">Office <span className="ms-auto"><div className="count">7</div></span></a></li>
                                                <li><a className="d-flex" href="javascript:void(0)">Sofas <span className="ms-auto"><div className="count">9</div></span></a></li>
                                                <li><a className="d-flex" href="javascript:void(0)">Table <span className="ms-auto"><div className="count">4</div></span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div className="widget">
                                    ...
                                    <div className="widget-content">
                                        ...
                                        <div className="price-filter">
                                            ...
                                            <a className="" href="javascript:void(0)"><i className="fas fa-filter"></i>Filter</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="widget">
                                            ...
                                            <ul className="list-unstyled list-style list-style-underline mb-0">
                                                <li>
                                                    <a className="d-flex" href="#">
                                                        ...
                                                        <span className="ms-auto"><div className="count">8</div></span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a className="d-flex" href="#">
                                                        ...
                                                        <span className="ms-auto"><div className="count">16</div></span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a className="d-flex" href="#">
                                                        ...
                                                        <span className="ms-auto"><div className="count">12</div></span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a className="d-flex" href="#">
                                                ...
                                                <li>
                                                    <a className="d-flex" href="#">
                                                        ...
                                                        <span className="ms-auto"><div className="count">18</div></span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a className="d-flex" href="#">
                                                        ...
                                                        <span className="ms-auto"><div className="count">20</div></span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a className="d-flex" href="#">
                                                ...
                                                <li>
                                                    <a className="d-flex" href="#">
                                                        ...
                                                        <span className="ms-auto"><div className="count">9</div></span>
                                                    </a>
                                                </li>
                                                ...
                                                <div className="product-content py-0">
                                                    <div className="product-info">
                                                        <div className="product-title">
                                                            <h3><a href="shop-single.html">Dining Chair</a></h3>
                                                        </div>
                                                    ...
                                                    {/* <!-- <a href="#" className="category">Cable</a> --> */}
                                    ...
                                    <div className="widget-content">
                                        <div className="popular-brand">
                                            <ul className="list-unstyled mb-0">
                                                <li><a href="#"> Daniela Anderson(1)</a></li>
                                                <li><a href="#"> Caranila(8)</a></li>
                                                <li><a href="#"> Moosa(4)</a></li>
                                                <li><a href="#"> Florial(5)</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-9">
                            ...
                            <div className="blog-sidebar-post-divider">
                            </div>
                                ...
                                <div className="col-lg-4">
                                    <div className="mb-3 select-border">
                                        <select className="form-control basic-select">
                                            <option value="1" selected>Accessories</option>
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="mb-3 select-border">
                                        <select className="form-control basic-select">
                                            <option value="1" selected>Any color</option>
                                ...
                                <div className="col-lg-6">
                                    <div className="mb-3 select-border">
                                        <select className="form-control basic-select">
                                            <option value="1" selected>Any size</option>
