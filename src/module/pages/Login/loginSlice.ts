...
export const getLatestCollectioData = createAsyncThunk<any>(
    'login/latestCollectionData',
    async(_, thunkAPI) => {
        try{
...
export const getBestCollectionData = createAsyncThunk<any>(
    'login/bestCollectionData',
    async(_, thunkAPI) => {
        try{
...
export const getRecentArticleData = createAsyncThunk<any>(
    'login/recentArticleData',
    async(_, thunkAPI) => {
        try{
...
export const getInTheSpotlightData = createAsyncThunk<any>(
    'login/spotlightData',
    async(_, thunkAPI) => {
        try{
...
export const getBannerCategoryData = createAsyncThunk<any>(
    'login/bannerCategory',
    async(_, thunkAPI) => {
        try{
...
export const getSaleBannerData = createAsyncThunk<any>(
    'login/saleBannerData',
    async(_, thunkAPI) => {
        try{
...
export const getTestimonialData = createAsyncThunk<any>(
    'login/testionialData',
    async(_, thunkAPI) => {
        try{
...
export const getBannerImages = createAsyncThunk<any>(
    'login/bannerImages',
    async(_, thunkAPI) => {
        try{
