...
const ShopSingle: React.FC = () => {
    ...
    return (
        <>
            <section className="header-inner header-inner-menu bg-overlay-secondary" style={{ backgroundImage: 'url(' + process.env.REACT_APP_IMAGE_BASE_URL + productDetail?.imagePath?.replace("~", "") + ')' }}>
                        ...
                        <div className="col-md-12 position-relative">
                            <div className="header-inner-title">
                                <div className="section-title">
                                    ...
                                    <h2 className="title text-white"><strong>Shop Single</strong></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div className="product-detail">
                                            ...
                                            <div className="product-price-rating">
                                                <div className="product-rating d-flex">
                                                    ...
                                                    <a href="#reviews" className="text-dark ms-2" rel="nofollow">(<span className="count">4</span> customer reviews)</a>
                                                </div>
                                                <div className="product-price">
                                                    <h4><del>${productDetail.oldPrice?.toFixed(2)}</del><span>${productDetail.price}</span></h4>
                                                </div>
                                            </div>
                                            ...
                                            <div className="justify-content-start d-flex add-to-cart-input">
                                                <div className="input-group">
                                                    <input type="number" name="quant[1]" className="form-control input-number mt-2 mt-sm-0" value={quantity} min="1" max="10" onChange={(e) => setQuantity(Number(e.target.value))} />
                                                </div>
                                                <a className="btn btn-primary mt-2 mt-sm-0" href="javascript:void(0)" onClick={() => addToCart()}> <span> Add To Cart </span> </a>
                                            </div>
                                            <div className="product-summary">
                                                <a className="" href="javascript:void(0)" onClick={() => addToWishlist()}><i className="far fa-heart"></i>Add to Wishlist</a>
                                                <a className="" href="#"><i className="fa fa-compress-alt" aria-hidden="true"></i>Compare</a>
                                            </div>
                                            ...
                                            <div className="product-detail-meta">
                                                ...
                                                <span>Category:
                                                    {productDetail?.category?.length > 0 ?
                                                        productDetail?.category?.map((value: any, key: number) => (
                                                ...
                                                <span>Tags:
                                                    {productDetail?.tags?.length > 0 ?
                                                        productDetail?.tags.map((value: any, key: number) => (
                                                            <a href="#"> {value.tag}, </a>
                                                        ))
                                                        : "-"
                                                    }
                                        ...
                                        <div className="nav-tabs-02">
                                            <nav>
                                                <ul className="nav nav-tabs mb-4" id="myTab2" role="tablist">
                                                    <li className="nav-item" role="presentation"> <a className="nav-link active" id="nav-description-tab" data-bs-toggle="tab" href="#nav-description" role="tab" aria-controls="nav-description" aria-selected="true">Description</a>
                                                    </li>
                                                    <li className="nav-item" role="presentation">
                                                        <a className="nav-link" id="nav-reviews-tab" data-bs-toggle="tab" href="#nav-reviews" role="tab" aria-controls="nav-reviews" aria-selected="false">Reviews</a>
                                                    </li>
                                                    <li className="nav-item" role="presentation">
                                                        <a className="nav-link" id="nav-custom-tab" data-bs-toggle="tab" href="#nav-custom" role="tab" aria-controls="nav-custom" aria-selected="false">Custom</a>
                                                    </li>
                                                </ul>
                                            </nav>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-12">
                                                            ...
                                                            <form className="row mt-4 align-items-center">
                                                                ...
                                                                <div className="col-sm-12">
                                                                    <a className="btn btn-primary btn-md mt-4" href="#"> Submit </a>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="tab-pane fade" id="nav-custom" role="tabpanel" aria-labelledby="nav-custom-tab">
                                                    <div className="row">
                                                        <div className="col-12">
                                                            ...
                                                            <p className="mb-0">Commitment is something that comes from understanding that everything has its price and then having the willingness to pay that price. This is important because nobody wants to put significant effort into something, only to find out after the fact that the price was too high.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div className="product-content">
                                                        <div className="product-info">
                                                            <div className="product-title">
                                                                <h3><a href="shop-single.html">{value.productName}</a></h3>
                                                            </div>
