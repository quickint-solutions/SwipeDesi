...
const RouteComponent: React.FC = () => {
    ...
    return (
        ...
        <React.Fragment>
                                    ...
                                    <div className="d-lg-flex align-items-center text-center">
                                        <div className="topbar-left mb-2 mb-lg-0">
                                            <div className="dropdown right-menu d-inline-flex pe-3 topbar-divider">
                                                ...
                                                <div className="dropdown-menu mt-0" aria-labelledby="dropdownMenuButton2">
                                                    <a className="dropdown-item" href="#"><img className="img-fluid country-flag" src={EnglishLang} alt="" />English</a>
                                                    <a className="dropdown-item" href="#"><img className="img-fluid country-flag" src={EnglishLang} alt="" />Francais</a>
                                                    <a className="dropdown-item" href="#"><img className="img-fluid country-flag" src={EnglishLang} alt="" />Deutsch</a>
                                                    <a className="dropdown-item" href="#"><img className="img-fluid country-flag" src={EnglishLang} alt="" />Italiano</a>
                                                </div>
                                            </div>
                                        ...
                                        <div className="topbar-right ms-auto justify-content-center align-items-center">
                                            <div className="topbar-call d-inline-flex topbar-divider pe-3">
                                                <a href="tel:+1 (403) 801-6969"><i className="bi bi-telephone me-2"></i>+1 (403) 801-69695</a>
                                            </div>
                            ...
                            <div className="add-listing">
                                ...
                                <div className="woo-action d-flex align-items-center">
                                    <div className="Compare-action woo-action-icon">
                                        <a href="#" className="compare-icon" title="Compare products"><i className="bi bi-shuffle"></i></a>
                                    </div>
                                    <div className="wishlist-action woo-action-icon">
                                        <a href="javascript:void(0)" className="wishlist-icon" onClick={() => navigateToWishlist()}><i className="bi bi-heart"></i></a>
                                    </div>
                                    <div className="cart dropdown woo-action-icon">
                                        {storageUserDetail ?
                                            <>
                                                <button className="dropdown-toggle p-0" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        ...
                                                        <ul className="cart-list ps-0">
                                                            {cartDetail.map((value: any, key: number) => (
                                                                <li className="d-flex" key={key}>
                                                                    <a className="remove-item" href="javascript:void(0)" onClick={() => removeItemFromCart(value)}><i className="fas fa-times"></i></a>
                                                                    <img className="img-fluid me-3" src={process.env.REACT_APP_IMAGE_BASE_URL + value.imagePath?.replace("~", "")} alt="cartImg" />
                                                                    <div className="cart-info">
                                                                        <a href="javascript:void(0)">{value.productName}</a>
                                                                        <span className="d-block">{value.quantity} x {value.price?.toFixed(2)}</span>
                                                                    </div>
                                                                </li>
                                                            ))}
                                                            {/* <li className="d-flex">
                                                    ...
                                                    <div className="cart-info">
                                                        ...
                                                        <div className="cart-footer">
                                                            ...
                                                            <div className="d-inline-block d-sm-flex">
                                                                <a className="col btn btn-secondary btn-sm me-2 px-4" href="javascript:void(0)" onClick={() => navigate("/Cart")}>View Cart</a>
                                                                <a className="col btn btn-sm btn-primary ms-0 mt-1 mt-sm-0 ms-sm-2 px-4" href="javascript:void(0)" onClick={() => navigate("/Checkout")}>Checkout</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    : ""}
                        ...
                        <div className="navbar-collapse collapse">
                            <ul className="nav navbar-nav">
                                <li className="nav-item active">
                                    <a className="nav-link active" aria-current="page" href="mandir.html"><Icon1Svg /><span>Mandir</span></a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" aria-current="page" href="#"><Icon1Svg /><span>Furniture</span></a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" aria-current="page" href="#"><Icon1Svg /><span>Handicraft</span></a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" aria-current="page" href="#"><Icon1Svg /><span>Jewelry</span></a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" aria-current="page" href="#"><Icon1Svg /><span>Pooja Accessories</span></a>
                                </li>
            ...
            <div className="modal fade login-register-modal" id="formLoginRegister" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="formLoginRegisterlabel" aria-hidden="true">
                                    ...
                                    <form method="post" className="login">
                                        ...
                                        <div className="row content">
                                            <div className="mb-3 col-sm-12 username">
                                                <input type="text" className="form-control" value={userDetail.name} required name="username" id="username" placeholder="Your name" onChange={(e) => handleUserCredential("name", e.target.value)} />
                                            </div>
                                            <div className="mb-3 col-sm-12 password">
                                                <input className="form-control" type="password" value={userDetail.pwd} required name="password" id="password" placeholder="Password" onChange={(e) => handleUserCredential("pwd", e.target.value)} />
                                            </div>
                                            ...
                                            <div className="col-sm-12 d-grid mb-3">
                                                <button type="button" className="btn btn-secondary btn-flat" onClick={() => handleLoginEvent()}>Sign in</button>
                                            </div>
                                            <div className="col-sm-12 d-grid mb-3">
                                                <button type="button" className="btn btn-gray btn-flat btn-next-register" onClick={() => setIsShowLoginForm(false)}>Creat An Account</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <form method="post" className="register">
                                        ...
                                        <div className="row content">
                                            <div className="mb-3 col-sm-12 name">
                                                <input type="text" className="form-control" value={registrationDetail.name} name="uname" id="uname" placeholder="User Name" onChange={(e) => handleRegistrationDetail("name", e.target.value)} />
                                            </div>
                                            <div className="mb-3 col-sm-12 email">
                                                <input type="email" className="form-control" value={registrationDetail.email} name="email" id="email" placeholder="Email" onChange={(e) => handleRegistrationDetail("email", e.target.value)} />
                                            </div>
                                            <div className="mb-3 col-sm-12 name">
                                                <input type="text" className="form-control" value={registrationDetail.address} name="address" id="address" placeholder="Address" onChange={(e) => handleRegistrationDetail("address", e.target.value)} />
                                            </div>
                                            <div className="mb-3 col-sm-12 password">
                                                <input className="form-control" type="password" value={registrationDetail.pwd} name="password" id="password" placeholder="Password" onChange={(e) => handleRegistrationDetail("pwd", e.target.value)} />
                                            </div>

                                            <div className="col-sm-12 d-grid mb-3">
                                                <button type="button" className="btn btn-secondary btn-flat" onClick={() => setIsShowRegisterFirstScreen(false)}>Next</button>
                                            </div>
                                            {/* <div className="col-sm-12 d-grid mb-3">
                                        ...
                                        <div className="row content">
                                             <div className="mb-3 col-sm-12 password">
                                                <input className="form-control" type="text" value={registrationDetail.fname} name="fname" id="fname" placeholder="First Name" onChange={(e) => handleRegistrationDetail("fname", e.target.value)} />
                                            </div>
                                            <div className="mb-3 col-sm-12 password">
                                                <input className="form-control" type="text" value={registrationDetail.lname} name="lname" id="lname" placeholder="Last Name" onChange={(e) => handleRegistrationDetail("lname", e.target.value)} />
                                            </div>
                                            <div className="mb-3 col-sm-12 email">
                                                <input type="text" className="form-control" value={registrationDetail.phoneNumber} name="phonenumber" id="phonenumber" placeholder="Phone number" onChange={(e) => handleRegistrationDetail("phoneNumber", e.target.value)} />
                                            </div>
                                            <div className="mb-3 col-sm-12 password">
                                                <input className="form-control" type="text" value={registrationDetail.postalCode} name="postalcode" id="postalcode" placeholder="Postalcode" onChange={(e) => handleRegistrationDetail("postalCode", e.target.value)} />
                                            </div>

                                            <div className="col-sm-12 d-grid mb-3">
                                                <button type="button" className="btn btn-secondary btn-flat" onClick={() => submitRegistrationDetail()}>Register</button>
                                            </div>
                                            {/* <div className="col-sm-12 d-grid mb-3">
                                                <button type="submit" className="btn btn-gray btn-flat btn-next-login">Already has an account</button>
                                            </div> */}
                            ...
                            <ul className="footer-contact list-unstyled">
                                ...
                                <li>
                                    <div className="footer-contact-info">
                                        ...
                                        <a className="mb-0" href="mailto:dhknd.inc@gmail.com" target="_blank" style={{ color: "#fff" }}>dhknd.inc@gmail.com</a>
                    ...
                    <div className="container">
                        <div className="row d-flex align-items-center">
                            <div className="col-md-12 col-lg-6 justify-content-lg-startr">
                                <p className="mb-0 text-white"><a href="#!" className="text-white">DHKND Management INC</a> © 2023 CREATED BY <a href="#!" className="text-white">WebMeHigh Infotech</a></p>
                            </div>
